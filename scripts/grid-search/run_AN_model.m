function run_AN_model(params, CF)
...
model_params.implnt = 0; % 0 = approximate model, 1=exact powerlaw implementation(See Zilany etal., 2009)
...
for iparamCF = 1:num_paramCF
	...
	model_params.CF_span = paramCF(iparamCF);
	...
	save(fullfile(savepath, putative_timbre, filename), 'params', 'AN', ...
		'CF', 'model_params', '-v7.3')
