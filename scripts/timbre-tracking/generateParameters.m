function [Fc_high, Fc_low, F0_high, F0_low] = generateParameters(task, nom_Fc, nom_F0, delta, rove, DL_var)
% Returns the geometrically centered spectral centroid and F0
% J. Fritzinger, updated 1/6/2021
%
% Inputs: task: 1 = timbre, 2 = pitch
%         nom_Fc: nominal spectral centroid
%         nom_F0: nominal fundamental frequency
%         delta: amount of change between the two tones, % between 0-1
%         rove: 1 = no rove, 2 = rove
%         DL_var: range from 1-8 
