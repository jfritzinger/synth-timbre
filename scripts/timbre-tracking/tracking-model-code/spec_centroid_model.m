function [DV, weighted_avg] = spec_centroid_model(cond, stimulus, Fc, F0, Fc_order, F0_order, plot)
% Plot AN and IC rates for N=# repetitions

Fs = 100e3; % Modeling sampling rate in Hz (must be 100, 200 or 500 kHz for AN model):

% Simulation parameters
nAN_fibers_per_CF = 10; % Number of stimulus repetitions (only 1 rep is needed if probability of firing is displayed - more reps needed for looking at spike times)
num_CFs = 100;
...
% CF parameters
CF_range = [400 3000]; % set a 'generic' default range of CFs
