...
d_para.tmin=str2num(get(handles.dpara_tmin_edit,'String'));
d_para.tmax=str2num(get(handles.dpara_tmax_edit,'String'));
d_para.dts=str2num(get(handles.dpara_dts_edit,'String'));
...
if ~isempty(gco)
    if gco==handles.Calculate_pushbutton || gco==handles.Plot_pushbutton
        ...
        if gco==handles.Plot_pushbutton
            ...
            f_para.x_offset=str2num(get(handles.fpara_x_offset_edit,'String'));
            f_para.x_scale=str2num(get(handles.fpara_x_scale_edit,'String'));
            f_para.tmin=str2num(get(handles.fpara_tmin_edit,'String'));
            f_para.tmax=str2num(get(handles.fpara_tmax_edit,'String'));
