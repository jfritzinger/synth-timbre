...
for suc=1:num_surros
    ...
    if exist(['SPIKE_order_surro_MEX_alt.',mexext],'file') && surro_plot==0
        [indies,error_count]=SPIKE_order_surro_MEX_alt(indies,firsts,seconds,num_swaps);
    ...
    if exist(['SPIKE_order_sim_ann_MEX_alt.',mexext],'file')
        [st_indy_simann,synf(suc),total_iter]=SPIKE_order_sim_ann_MEX_alt(surro_mat);
    else
