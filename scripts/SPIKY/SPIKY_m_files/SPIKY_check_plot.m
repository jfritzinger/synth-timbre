...
tmin_in=str2num(regexprep(tmin_str_in,f_para.regexp_str_scalar_float,''));
if ~isempty(tmin_in)
...
tmax_in=str2num(regexprep(tmax_str_in,f_para.regexp_str_scalar_float,''));
if ~isempty(tmin_in)
...
x_offset_in=str2num(regexprep(x_offset_str_in,f_para.regexp_str_scalar_float,''));
...
x_scale_in=abs(str2num(regexprep(x_scale_str_in,f_para.regexp_str_scalar_float,'')));
...
mao_in=abs(round(str2num(regexprep(mao_str_in,f_para.regexp_str_scalar_integer,''))));
...
psth_window_in=abs(round(str2num(regexprep(psth_window_str_in,f_para.regexp_str_scalar_integer,''))));
...
if str2num(get(handles.fpara_tmin_edit,'String'))>=str2num(get(handles.fpara_tmax_edit,'String'))
    set(0,'DefaultUIControlFontSize',16);
...
if str2num(get(handles.fpara_tmin_edit,'String'))<str2num(get(handles.dpara_tmin_edit,'String'))
    set(0,'DefaultUIControlFontSize',16);
...
if str2num(get(handles.fpara_tmax_edit,'String'))>str2num(get(handles.dpara_tmax_edit,'String'))
    set(0,'DefaultUIControlFontSize',16);
