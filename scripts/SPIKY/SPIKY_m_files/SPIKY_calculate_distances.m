...
m_para.all_measures_str={'Stimulus';'Spikes';'PS';'I';'S';'S_r';'S_f';'C';'D';'RI_S';'S_N';'S^A';'S_{NE}';'Si';'Si_r';'Si_f';'Sd';'Sd_N';'Sd_E';'Sd_{NE}';'V';'R'};
m_para.all_measures_string={'Stimulus';'Spikes';'PSTH';'ISI';'SPIKE';'SPIKE_realtime';'SPIKE_forward';'SPIKE_synchro';'SPIKE_order';'RI_SPIKE';...
...
m_para.ri_spike_pili=10;
m_para.spike_neb_pili=11;
m_para.spike_eero_pili=12;
m_para.spike_neb_eero_pili=13;
m_para.spike_pico=14;
m_para.realtime_spike_pico=15;
m_para.forward_spike_pico=16;
m_para.spike_disc=17;
m_para.spike_neb_disc=18;
m_para.spike_eero_disc=19;
m_para.spike_neb_eero_disc=20;
m_para.victor=21;
m_para.van_rossum=22;
...
m_para.pili_measures=[m_para.spike_pili m_para.ri_spike_pili m_para.realtime_spike_pili m_para.forward_spike_pili m_para.spike_neb_pili ...
    m_para.spike_eero_pili m_para.spike_neb_eero_pili];
m_para.spike_measures=[m_para.spike_pili m_para.ri_spike_pili m_para.spike_neb_pili m_para.spike_eero_pili m_para.spike_neb_eero_pili m_para.spike_disc ...
    m_para.spike_neb_disc m_para.spike_eero_disc m_para.spike_neb_eero_disc];   % ##############
...
% ##################################### cSPIKE ###############################
    ...
    if f_para.edge_correction
        ...
        if any(f_para.subplot_posi([m_para.spike_pico m_para.realtime_spike_pico m_para.spike_pili m_para.ri_spike_pili m_para.realtime_spike_pili]))
            prev_edge_cor_indy=cell(1,d_para.num_trains);
        end
        if any(f_para.subplot_posi([m_para.spike_pico m_para.forward_spike_pico m_para.spike_pili m_para.ri_spike_pili m_para.forward_spike_pili]))
    ...
    for ruc=r_para.ruc_initial:r_para.ruc_final
        ...
        if any(f_para.subplot_posi([m_para.spikesync_disc m_para.isi_pico m_para.spike_pili m_para.ri_spike_pili m_para.spike_disc]))
        ...
        if any(f_para.subplot_posi([m_para.spike_pico m_para.realtime_spike_pico m_para.spike_pili m_para.ri_spike_pili m_para.realtime_spike_pili m_para.spike_disc])) % SPIKE-Pre-Pico
            ...
            if any(f_para.subplot_posi([m_para.spike_pili m_para.ri_spike_pili m_para.realtime_spike_pili]))                     % SPIKE-Pre-pili
        ...
        if any(f_para.subplot_posi([m_para.spike_pico m_para.ri_spike_pili m_para.forward_spike_pico m_para.spike_pili m_para.forward_spike_pili])) 
            % SPIKE-Forward-Pico
            ...
            if any(f_para.subplot_posi([m_para.spike_pili m_para.ri_spike_pili m_para.forward_spike_pili]))                       % SPIKE-forward-pili
        ...
        if m_para.num_pili_measures>0
            ...
            if any(f_para.subplot_posi(m_para.spike_measures))                                                   % any SPIKE-measure
                ...
                if f_para.subplot_posi(m_para.ri_spike_pili)                                         % RI-SPIKE-pili  (added measure but not yet included in GUI)
                        ...
                        for trac2=trac1+1:d_para.num_trains
                            ...
                            if ruc==r_para.ruc_initial
                                ...
                                if num_pair_all_spikes(pac)>0
                                    ...
                                    if exist(['SPIKY_SPIKEsynchro_MEX.',mexext],'file')  % #################################### check spikes on edges and single spikes
                                        if pac==1
...
%                                                     end
            ...
            if any(f_para.subplot_posi(spike_disc_vect))
                % spike_pili_vect=[m_para.spike_pili m_para.ri_spike_pili m_para.spike_neb_pili m_para.spike_eero_pili m_para.spike_neb_eero_pili];
    ...
    if m_para.num_disc_measures>0
        if f_para.subplot_posi(m_para.spikesync_disc)
            ...
            ave_bi_vect(m_para.disc_bi_measures_indy(m_para.measure_indy(m_para.spikesync_disc)),:)=...
                (ave_bi_vect(m_para.disc_bi_measures_indy(m_para.measure_indy(m_para.spikesync_disc)),:)+(num_pair_all_spikes==0))./(num_pair_all_spikes+(num_pair_all_spikes==0));
        end
        if f_para.subplot_posi(m_para.spikeorder_disc)
            if sum(num_pair_all_spikes)>0
            ...
            ave_bi_vect(m_para.disc_bi_measures_indy(m_para.measure_indy(m_para.spikeorder_disc)),:)=...
                (ave_bi_vect(m_para.disc_bi_measures_indy(m_para.measure_indy(m_para.spikeorder_disc)),:)+(num_pair_all_spikes==0))./(num_pair_all_spikes+(num_pair_all_spikes==0));
        end
        if any(f_para.subplot_posi(spike_disc_vect))
            for sdc=1:num_spike_disc
                %ave_bi_vect(m_para.disc_bi_measures_indy(m_para.measure_indy(m_para.spikesync_disc)),:)=...
                ...
                ave_bi_vect(m_para.disc_bi_measures_indy(m_para.measure_indy(disc_indy)),:)=...
                    (ave_bi_vect(m_para.disc_bi_measures_indy(m_para.measure_indy(disc_indy)),:)+(num_pair_all_spikes==0))./(num_pair_all_spikes+(num_pair_all_spikes==0));
            end
        end
    end
