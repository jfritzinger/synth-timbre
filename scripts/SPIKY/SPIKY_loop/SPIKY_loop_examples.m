...
m_para.all_measures_string={'ISI';'SPIKE';'RI-SPIKE';'SPIKE_realtime';'SPIKE_forward';'SPIKE_synchro';'SPIKE_order';'PSTH'};  % order of select_measures

para.select_measures      =[0 1 0 0 0 0 0 0];  % Select measures (0-calculate,1-do not calculate)
...
elseif dataset==4
    ...
    for trac=1:length(tracs)
        ...
        para.triggered_averages{trac}=round(spikes(tracs(trac),1:num_spikes)/para.dts)*para.dts;% Triggered averaging over all time instants a certain neuron fires
    end
