...
%m_para.all_measures_string={'PSTH';'SPIKE_Synchro';'ISI';'SPIKE';'SPIKE_realtime';'SPIKE_forward';'SPIKE_N';'SPIKE_E';'SPIKE_NE';'SPIKE_discrete'}; 
% order of select_measures
...
m_para.all_measures_string={'PSTH';'SPIKE_Synchro';'ISI';'SPIKE';'SPIKE_realtime';'SPIKE_forward';'SPIKE_N';'SPIKE_E';'SPIKE_NE';'SPIKE_disc';...
    'SPIKE_disc_N';'SPIKE_disc_E';'SPIKE_disc_NE'};
% order of select_measures
